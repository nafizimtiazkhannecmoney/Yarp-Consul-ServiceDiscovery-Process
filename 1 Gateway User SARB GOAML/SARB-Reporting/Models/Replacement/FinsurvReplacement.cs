...
namespace SARB_Reporting.Models.Replacement
{
    [XmlRoot("FINSURV", Namespace = "", IsNullable = false)]
    public class FinsurvReplacement
    {
        public FinsurvReplacement()
        {
            this.OriginalTransactions = new OriginalTransaction();
        ...
        public OriginalTransaction OriginalTransactions { get; set; }
    ...
    public class OriginalTransaction
    {
        ...
        [XmlAttribute]
        public string? ReplacementOriginalReference { get; set; } 
    ...
    public class MonetaryDetails
    {
        ...
        [XmlAttribute("ReversalTrnRefNumber")]
        public string? ReversalTrnRefNumber { get; set; }

        [XmlAttribute("ReversalSequence")]
        public string? ReversalSequence { get; set; }
